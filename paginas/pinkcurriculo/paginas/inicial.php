    ...
    <div class="resume">
        <div class="base">
            <div class="profile">
                ...
                <div class="info">
                    <h1 class="name">Luana Cavalcanti</h1>
                </div>
            </div>
            <div class="about">
                <h3>Sobre mim</h3> Graduanda em Ciências Biológicas, Web Designer.
            </div>
            <div class="contact">
                <h3>Contato</h3>
            ...
            <div class="follow">
                ...
                <div class="box">
                    ...
                    <a href="https://www.instagram.com/luanacavalcantis/" target="_blank"><i class="fab fa-instagram "></i></a>
                    <a href="https://www.pinterest.com/whylune/" target="_blank"><i class="fab fa-pinterest"></i></a>
                    <a href="https://www.linkedin.com/in/luana-cavalcanti-176b1b1a0/" target="_blank"><i class="fab fa-linkedin"></i></a>
                    <a href="https://github.com/loanac" target="_blank"><i class="fab fa-github"></i></a>
        ...
        <div class="func">
            <div class="work">
                <h3><i class="fa fa-briefcase"></i>Cursos</h3>
                <ul>

                    <li><span>Web Designer</span><small>Senac</small><small>Set 2020 - Out 2020</small></li>
                    <li><span>Inglês Básico</span><small>Prime Cursos</small><small>Conclusão: 2018</small></li>
                </ul>
            </div>
            <div class="edu">
                <h3><i class="fa fa-graduation-cap"></i>Formação</h3>
                <ul>
                    <li><span>Bacharelado em Ciências Biológicas<br></span><small>UFPE</small><small>perído de entrada: 2019.2</small></li>
                    <li><span>Ensino Médio</span><small>Colégio Fernando Ferrai</small><small>Conclusão: 2017</small></li>
            ...
            <div class="skills-prog">
                ...
                <ul>
                    ...
                    <li data-percent="30"><span>JavaScript</span>
                        <div class="skills-bar">
                            <div class="bar"></div>
                        </div>
                    </li>
                    <li data-percent="30"><span>jQuery</span>
                        <div class="skills-bar">
                            <div class="bar"></div>
                        </div>
                    </li>
                    <li data-percent="70"><span>Bootstrap</span>
                        <div class="skills-bar">
                            <div class="bar"></div>
                        </div>
                    </li>
                    ...
                    <li data-percent="20"><span>MySQL</span>
                        <div class="skills-bar">
                            <div class="bar"></div>
                        </div>
                    </li>
            ...
            <div class="interests">
                ...
                <div class="interests-items">
                    <div class="art"><i class="fas fa-palette"></i><span>Desenhos</span></div>
                    <div class="art"><i class="fas fa-book"></i><span>Livros</span></div>
                    <div class="movies"><i class="fas fa-film"></i><span>Filmes</span></div>
                    <div class="music"><i class="fas fa-headphones"></i><span>Música</span></div>
                    <div class="games"><i class="fas fa-gamepad"></i><span>Jogos</span></div>
                </div>
            </div>
        </div>
    </div>
